...
$filtered = $whitelist;
if ( $search ) {
    $filtered = array_filter( $whitelist, function( $d ) use ( $search ) { return strpos( $d, $search ) !== false; } );
}
...
<div class="wrap">
    ...
    <div style="margin-top:20px;">
        ...
        <table class="widefat striped">
            ...
            <tbody>
                <?php $i = 1; foreach ( $filtered as $domain ) : ?>
                <tr>
        ...
        <?php if ( $search ) : ?>
            <p style="margin-top:10px;color:#666;">
                <?php printf( esc_html__( 'Showing %1$d of %2$d matching "%3$s"', 'darkshield' ), count( $filtered ), count( $whitelist ), esc_html( $search ) ); ?>
            </p>
        <?php endif; ?>
