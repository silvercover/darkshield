...
<div class="wrap">
    ...
    <div style="margin-top:20px;">
        ...
        <div class="card" style="max-width:100%;padding:20px;margin-bottom:20px;">
            ...
            <?php
            $labels = array(
                'block_fonts' => 'Fonts', 'block_cdn' => 'CDN', 'block_analytics' => 'Analytics',
                'block_updates' => 'Updates', 'block_gravatar' => 'Gravatar', 'block_embeds' => 'Embeds',
                'block_recaptcha' => 'reCAPTCHA', 'block_heartbeat' => 'Heartbeat', 'block_email' => 'Email',
        ...
        <div class="card" style="max-width:100%;padding:20px;">
            ...
            <p style="margin-top:5px;color:#666;font-size:12px;">
                <?php
                printf(
                    esc_html__( 'Plugin version: %s | Mode: %s', 'darkshield' ),
