...
class DarkShield_Settings {
    ...
    public function register_settings() {
        register_setting( 'darkshield_options', 'darkshield_settings', array(
            'type'              => 'array',
            'sanitize_callback' => array( $this, 'sanitize_settings' ),
        ) );

        register_setting( 'darkshield_options', 'darkshield_allowed_services', array(
            'type'              => 'string',
        ...
        add_settings_field( 'ds_log_enabled', __( 'Enable Logging', 'darkshield' ), array( $this, 'render_checkbox' ), 'darkshield-settings', 'ds_log', array( 'key' => 'log_enabled', 'desc' => __( 'Log blocked and allowed requests.', 'darkshield' ) ) );
        add_settings_field( 'ds_log_retention', __( 'Retention (days)', 'darkshield' ), array( $this, 'render_number' ), 'darkshield-settings', 'ds_log', array( 'key' => 'log_retention', 'min' => 1, 'max' => 365 ) );
    }
